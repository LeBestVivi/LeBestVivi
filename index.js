...
client.on('message',message => {
    ...
    if (args[0].toLocaleLowerCase()=== prefix + '8ball'){
        ...
        let rep = ["Non :x:", "J'ai envie de dormir :zzz:", "Peut être... :thinking:", "Absolument ::white_check_mark: :"];
    ...
    if (args[0].toLocaleLowerCase()=== prefix + 'help'){
        ...
        let embed = new Discord.RichEmbed()
            .setAuthor(message.author.tag)
            .setColor("BLUE")
            .addField("Commandes :", "    !help Affiche la liste des commandes")
            .addField("Modération :", "    !ban <mention> Bannir un membre du serveur\n !kick <mention> Expulser un membre du serveur\n !warn <mention> Avertir un membre\n !infactions <mention> avec le !warn, voir les infractions d'un membre \n !clear <nombre> Effacer les messages d'un salon")
            .addField("Divertissement :", "    !8ball <question> Pose une question, le bot te répond")
            .setFooter("Vivi BOT")
        message.channel.send(embed)
